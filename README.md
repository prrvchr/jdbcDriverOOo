...
- [HyperSQL or HsqlDB][9] version 2.70.
...
If you are using the HsqlDB driver with **LibreOffice on Linux**, then you are subject to [bug 139538][16].  
To work around the problem, please uninstall the packages:
- libreoffice-sdbc-hsqldb
- libhsqldb1.8.0-java

If you still want to use the Embedded HsqlDB functionality provided by LibreOffice, then install the [HsqlDBembeddedOOo][17] extension.  
...
- Not being able to use prepared SQL statements (PreparedStatement) see [bug 132195][31].
...
- I especially want to thank fredt at [hsqldb.org][33] for:
...
- Rewrite of [Driver][34] in Java version 11 OpenJDK amd64 under Eclipse IDE for Java Developers version 4.23.0 with the plugins:
...
- Writing the `Statement`, `PreparedStatement`, `CallableStatement`, `ResultSet`, `...` services of JDBC (thanks to hanya for [MRI][35] which was of great help to me...)

    - [com.sun.star.sdb.*][36]
    - [com.sun.star.sdbc.*][37]
    - [com.sun.star.sdbcx.*][38]

- Integration in jdbcDriverOOo of **H2** and **Derby** JDBC drivers in addition to **HsqlDB**. Implementation of Java Services:

    - [Driver-HsqlDB.jar][39]
    - [Driver-H2.jar][40]
    - [Driver-Derby.jar][41]
...
- Writing of [com.sun.star.sdbcx.Driver][42]. This high-level driver must allow the **management of users, roles and privileges in Base**. Its use can be disabled via the menu: **Tools -> Options -> Base drivers -> JDBC Driver**.

- Implemented a Java service provider [UnoLogger.jar][43] for the [SLF4J][44] API to be able to redirect driver logging from the underlying databases to the UNO API [com.sun.star.logging.*][45].

- Rewrite, following the MVC model, of the [Options][46] dialog accessible via the menu: **Tools -> Options -> Base drivers -> JDBC Driver**, to allow:

    - Updating and/or adding Java archives of JDBC drivers.
    - Enabling driver logging of the underlying database.

- Writing, following the MVC model, [administration windows][47] for users and roles (groups) and their associated privileges, accessible in Base via the menu: **Administration -> User administration** and/or **Administration - > Group administration**, allowing:
...
[4]: <https://prrvchr.github.io/jdbcDriverOOo/source/jdbcDriverOOo/registration/PrivacyPolicy_en>
[5]: <https://prrvchr.github.io/jdbcDriverOOo/#what-has-been-done-for-version-004>
...
[17]: <https://prrvchr.github.io/HsqlDBembeddedOOo/>
[18]: <img/jdbcDriverOOo.png>
[19]: <https://github.com/prrvchr/jdbcDriverOOo/raw/master/jdbcDriverOOo.oxt>
[20]: <img/jdbcDriverOOo-1.png>
[21]: <img/jdbcDriverOOo-2.png>
[22]: <img/jdbcDriverOOo-3.png>
[23]: <img/jdbcDriverOOo-4.png>
[24]: <img/jdbcDriverOOo-5.png>
[25]: <img/jdbcDriverOOo-6.png>
[26]: <img/jdbcDriverOOo-7.png>
[27]: <img/jdbcDriverOOo-8.png>
[28]: <img/jdbcDriverOOo-9.png>
[29]: <img/jdbcDriverOOo-10.png>
