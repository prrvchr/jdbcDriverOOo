...
If you are using the HsqlDB driver with **LibreOffice on Linux**, then you are subject to [bug 139538][15].  
...
- Install ![jdbcDriverOOo logo][17] **[jdbcDriverOOo.oxt][18]** extension version 0.0.4.
...
- Not being able to use prepared SQL statements (PreparedStatement) see [bug 132195][30].
...
- I especially want to thank fredt at [hsqldb.org][32] for:
...
- Rewrite of [Driver][33] in Java version 11 OpenJDK amd64 under Eclipse IDE for Java Developers version 4.23.0 with the plugins:
...
- Writing the `Statement`, `PreparedStatement`, `CallableStatement`, `ResultSet`, `...` services of JDBC (thanks to hanya for [MRI][34] which was of great help to me...)
...
- Writing of [com.sun.star.sdbcx.Driver][41]. This high-level driver must allow the **management of users, roles and privileges in Base**. Its use can be disabled via the menu: **Tools -> Options -> Base drivers -> JDBC Driver**.

- Implemented a Java service provider [UnoLogger.jar][42] for the [SLF4J][43] API to be able to redirect driver logging from the underlying databases to the UNO API [com.sun.star.logging.*][44].

- Rewrite, following the MVC model, of the [Options][45] dialog accessible via the menu: **Tools -> Options -> Base drivers -> JDBC Driver**, to allow:
...
[19]: <img/jdbcDriverOOo-1.png>
[20]: <img/jdbcDriverOOo-2.png>
[21]: <img/jdbcDriverOOo-3.png>
[22]: <img/jdbcDriverOOo-4.png>
[23]: <img/jdbcDriverOOo-5.png>
[24]: <img/jdbcDriverOOo-6.png>
[25]: <img/jdbcDriverOOo-7.png>
[26]: <img/jdbcDriverOOo-8.png>
[27]: <img/jdbcDriverOOo-9.png>
[28]: <img/jdbcDriverOOo-10.png>
