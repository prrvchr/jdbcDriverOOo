...
import io.github.prrvchr.rowset.internal.CachedRowSetReader;
import io.github.prrvchr.rowset.internal.CachedRowSetWriter;
import io.github.prrvchr.rowset.internal.InsertRow;
import io.github.prrvchr.rowset.internal.BaseRow;
import io.github.prrvchr.rowset.internal.Row;
import io.github.prrvchr.rowset.providers.RIOptimisticProvider;
               ...
               CachedRowSet
{
     ...
     */
    private String DEFAULT_SYNC_PROVIDER = "io.github.prrvchr.rowset.providers.RIOptimisticProvider";
    ...
    public java.io.InputStream getUnicodeStream(int columnIndex) throws SQLException {
        ...
        // XXX: Removing deprecated StringBufferInputStream use
        //unicodeStream = new StringBufferInputStream(value.toString());
        try {
            unicodeStream = new ByteArrayInputStream(value.toString().getBytes("UTF-8"));
        }
        ...
        if (value instanceof Struct) {
            ...
            if (c != null) {
                ...
                try {
                    ...
                    manager.checkPackageAccess(c.getPackageName());
