...
package io.github.prrvchr.rowset.internal;
...
import io.github.prrvchr.rowset.CachedRowSetImpl;
 ...
 */
    public boolean writeData(RowSetInternal caller) throws SQLException {
        ...
        //java.sql.ResultSet result = crs.resultSet;
        this.crsResolve = (CachedRowSetImpl) crs.createCopySchema();
    ...
    */
        ...
        throws SQLException
    {
        ...
        try (PreparedStatement pstmtSel = con.prepareStatement(selectCmd,
             ...
             ResultSet rs2 = con.getMetaData().getPrimaryKeys(null, null, crs.getTableName()))
        {
    ...
    */
    ...
    public void commit(CachedRowSetImpl crs, boolean updateRowset)
        throws SQLException
    {
        con.commit();
        if (updateRowset) {
